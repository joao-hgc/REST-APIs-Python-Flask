...
class Hoteis(Resource):
    def get(self):
        ...
        if not parametros.get('cidade'):
            ...
            resultado = cursor.execute(consulta_sem_ciadade, tupla)
...
class Hotel(Resource):
    ...
    argumentos.add_argument('nome', type=str, required=True, help="The field 'nome' cannot be left blanck")
    ...
    def post(self, hotel_id):
        ...
        try:
            ...
            return{'message':'An internal error ocorred trying to save hotel'}, 500 # Internal ServerError
        return hotel.json()
